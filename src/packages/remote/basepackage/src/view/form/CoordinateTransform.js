...
Ext.define("Basepackage.view.form.CoordinateTransform", {
    ...
    initComponent: function() {
        ...
        me.on('afterrender', function(){
            var transformvectorlayer = Basepackage.util.Layer.getLayerByName(
    ...
    toggleBtnVisibility: function(field) {
        var allBtns = Ext.ComponentQuery.query(
                'base-form-coordinatetransform button[name=transform]'),
    ...
    transform: function(evtOrBtnOrArray) {
        var me = Ext.ComponentQuery.query(
            'base-form-coordinatetransform')[0],
            map = Ext.ComponentQuery.query('base-component-map')[0].getMap(),
            mapProjection = map.getView().getProjection(),
            fieldSets = me.query('fieldset'),
            transformvectorlayer = Basepackage.util.Layer.getLayerByName(
                'transformvectorlayer'),
