 ...
 */
/**
 * @class Koala.view.wps.WpsCombo
 */
Ext.define('Koala.view.wps.WpsCombo', {
    extend: 'Ext.form.field.ComboBox',
    xtype: 'wps-combo',

    requires: [
        'Ext.Promise',
        'Koala.view.wps.WpsComboModel',
        'Koala.view.wps.WpsComboController'
    ],

    controller: 'wps-combo',
    viewModel: {
        type: 'wps-combo'
    },
    ...
    generateInput: function() {
        ...
        var input = generator.createLiteralDataInput_wps_1_0_and_2_0(
            this.identifier, dataType, this.unitOfMeasure, this.getValue()
        );
