 ...
 */
/**
 * @class Koala.view.panel.TimeSeriesController
 */
Ext.define('Koala.view.panel.TimeSeriesController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.k-panel-timeseries',
    requires: [
    ...
    /**
     * Disable UTC-Button when TimeSeries is shown.
     */
     ...
     * Enable UTC-Button when TimeSeries is closed.
     */
    ...
    createOrUpdateChart: function(olLayer, olFeat) {
        ...
        // if the panel contains a chart rendered for a feature from the
