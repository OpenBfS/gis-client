 ...
 */
/**
 * @class Koala.view.grid.StationSearchController
 */
Ext.define('Koala.view.grid.StationSearchController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.k-grid-stationsearch',

    /**
     * The handler for the mouse enter event of a grid record.
     * @param {Koala.view.grid.StationSearch} grid The grid.
    ...
    onItemClick: function(grid, record) {
        ...
        view.fit(extent, {size: map.getSize(), maxZoom: 10});
    },
