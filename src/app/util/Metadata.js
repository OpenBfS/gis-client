...
Ext.define('Koala.util.Metadata', {
    ...
    statics: {
        ...
        /**
         * A copy of "Koala.util.Layer.getInternalLayerConfig" but with different defaults specific for 'local' vector layers.
         *
         * @param {Object} metadata the metadata
         * @returns a config object with flags set from the metadata
         */
        getVectorLayerConfig: function(metadata) {
