    ...
    statics: {
        ...
        getFiltersFromMetadata: function(metadata) {
            ...
            Ext.each(filters, function(f) {
                if (f.effectivevalue && !Ext.isArray(f.effectivevalue) && !Ext.isNumber(f.effectivevalue) && !Ext.isBoolean(f.effectivevalue)) {
        ...
        checkAlwaysOnTopLayers: function(map) {
            ...
            Ext.each(map.getLayers().getArray(), function(layer) {
                ...
                if (alwaysOnTop || layer.get('isSelectionLayer') || layer.get('isOrsRoutingLayer')) {
