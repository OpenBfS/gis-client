...
var GeoPackageConnection = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        this.adapter = db_1.Db.create(this.filePath);
                        return [4 /*yield*/, this.adapter.initialize()];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    GeoPackageConnection.prototype.transaction = function (func) {
