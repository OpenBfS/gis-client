...
var rtree_sql_js_1 = __importDefault(require("rtree-sql.js"));
/**
...
var SqljsAdapter = /** @class */ (function () {
    ...
    SqljsAdapter.setSqljsWasmLocateFile = function (locateFile) {
     ...
     * @param sql
     */
    SqljsAdapter.prototype.prepareStatement = function (sql) {
     ...
     * @return {Number} last inserted row id
     */
    SqljsAdapter.prototype.bindAndInsert = function (statement, params) {
        if (params && !(params instanceof Array)) {
            for (var key in params) {
                params['$' + key] = params[key];
            }
     ...
     * @param statement
     */
    SqljsAdapter.prototype.closeStatement = function (statement) {
        statement.free();
    };
    /**
    ...
    SqljsAdapter.prototype.transaction = function (func) {
    ...
    SqljsAdapter.sqljsWasmLocateFile = function (filename) { return filename; };
    return SqljsAdapter;
}());
