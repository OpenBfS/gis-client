...
export declare class FeatureTableStyles {
     ...
     * @return {any}
     */
    setFeatureStyles(featureId: number, featureStyles: FeatureStyles): {
        styles: {
            styleDefault: number;
            styles: number[];
        };
     ...
     * @return {any}
     */
    setFeatureStyle(featureId: number, geometryType: GeometryType, featureStyle: FeatureStyle): {
        style: number;
        icon: number;
        deleted?: {
            style: number;
     ...
     * @return {any}
     */
    setFeatureStyleDefault(featureId: number, featureStyle: FeatureStyle): {
        style: number;
        icon: number;
        deleted?: {
            style: number;
     ...
     * @return {any}
     */
    setStyles(featureId: number, styles: Styles): {
        styleDefault: number;
        styles: number[];
        deleted: number;
    };
     ...
     * @return {any}
     */
    setIcons(featureId: number, icons: Icons): {
        iconDefault: number;
        icons: number[];
        deleted: number;
    };
