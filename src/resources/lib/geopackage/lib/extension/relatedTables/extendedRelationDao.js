...
var ExtendedRelationDao = /** @class */ (function (_super) {
    ...
    ExtendedRelationDao.ID = 'id';
    ExtendedRelationDao.COLUMN_ID = ExtendedRelationDao.TABLE_NAME + '.' + ExtendedRelationDao.ID;
    ExtendedRelationDao.BASE_TABLE_NAME = 'base_table_name';
    ExtendedRelationDao.COLUMN_BASE_TABLE_NAME = ExtendedRelationDao.TABLE_NAME + '.' + ExtendedRelationDao.BASE_TABLE_NAME;
    ExtendedRelationDao.BASE_PRIMARY_COLUMN = 'base_primary_column';
    ExtendedRelationDao.COLUMN_BASE_PRIMARY_COLUMN = ExtendedRelationDao.TABLE_NAME + '.' + ExtendedRelationDao.BASE_PRIMARY_COLUMN;
    ExtendedRelationDao.RELATED_TABLE_NAME = 'related_table_name';
    ExtendedRelationDao.COLUMN_RELATED_TABLE_NAME = ExtendedRelationDao.TABLE_NAME + '.' + ExtendedRelationDao.RELATED_TABLE_NAME;
    ExtendedRelationDao.RELATED_PRIMARY_COLUMN = 'related_primary_column';
    ExtendedRelationDao.COLUMN_RELATED_PRIMARY_COLUMN = ExtendedRelationDao.TABLE_NAME + '.' + ExtendedRelationDao.RELATED_PRIMARY_COLUMN;
    ExtendedRelationDao.RELATION_NAME = 'relation_name';
    ExtendedRelationDao.COLUMN_RELATION_NAME = ExtendedRelationDao.TABLE_NAME + '.' + ExtendedRelationDao.RELATION_NAME;
    ExtendedRelationDao.MAPPING_TABLE_NAME = 'mapping_table_name';
    ExtendedRelationDao.COLUMN_MAPPING_TABLE_NAME = ExtendedRelationDao.TABLE_NAME + '.' + ExtendedRelationDao.MAPPING_TABLE_NAME;
