...
var FeatureTableIndex = /** @class */ (function (_super) {
    ...
    function FeatureTableIndex(geoPackage, featureDao) {
        ...
        _this.extensionName = FeatureTableIndex.EXTENSION_NAME;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!indexed) {
                    ...
                    tableIndex = this.getOrCreateTableIndex();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(!indexed || force)) return [3 /*break*/, 5];
                        this.getOrCreateExtension();
                    ...
                    case 4:
                        _a.sent();
                        return [2 /*return*/, this.indexTable(tableIndex)];
                    case 5: return [2 /*return*/, indexed];
                }
            });
        });
    };
    ...
    FeatureTableIndex.prototype.getOrCreateExtension = function () {
        return this.getOrCreate(this.extensionName, this.tableName, this.columnName, this.extensionDefinition, extension_1.Extension.READ_WRITE);
    };
    /**
    ...
    FeatureTableIndex.EXTENSION_NAME = extension_1.Extension.buildExtensionName(FeatureTableIndex.EXTENSION_GEOMETRY_INDEX_AUTHOR, FeatureTableIndex.EXTENSION_GEOMETRY_INDEX_NAME_NO_AUTHOR);
