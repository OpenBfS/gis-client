...
var Dao = /** @class */ (function () {
     ...
     */
    Dao.prototype.queryForEach = function (field, value, groupBy, having, orderBy, columns) {
        if (!field) {
            var query = sqliteQueryBuilder_1.SqliteQueryBuilder.buildQuery(false, "'" + this.gpkgTableName + "'", columns, undefined, undefined, groupBy, having, orderBy);
    ...
    Dao.prototype.buildWhereArgs = function (values) {
        ...
        else if (values instanceof columnValues_1.ColumnValues) {
     ...
     * Drops this table
     */
    Dao.prototype.dropTableWithTableName = function (tableName) {
        coreSQLUtils_1.CoreSQLUtils.dropTable(this.geoPackage.connection, tableName);
    };
    /**
     * Rename the table
