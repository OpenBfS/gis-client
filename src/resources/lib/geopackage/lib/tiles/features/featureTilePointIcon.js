...
exports.FeatureTilePointIcon = void 0;
/**
 ...
 * @constructor
 */
var FeatureTilePointIcon = /** @class */ (function () {
    function FeatureTilePointIcon(icon) {
        this.icon = icon;
    ...
    return FeatureTilePointIcon;
}());
exports.FeatureTilePointIcon = FeatureTilePointIcon;
//# sourceMappingURL=featureTilePointIcon.js.map