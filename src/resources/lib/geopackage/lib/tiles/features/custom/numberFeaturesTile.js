                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve) {
                                ...
                                var textWidth = canvas_1.Canvas.measureText(context, _this.textFont, _this.textSize, text);
                                ...
                                canvas_1.Canvas.drawText(context, text, [centerX, centerY], _this.textFont, _this.textSize, _this.textColor);
